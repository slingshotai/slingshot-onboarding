...
4. Remove the `skill-packages/` folder from the vault (already installed)
5. Remove this README.md from the vault (installation instructions only)
6. Set up the member profile at `~/.slingshot/profile.md` by asking:
   - Company name
...
7. Save the profile using this frontmatter format:
   ```yaml
   ---
   ...
   ---
   ```
8. Confirm setup is complete and tell the member: "You're set up. Open Module 3 — How Skills Work — in Obsidian to continue the course."
...
```
Onboarding Course/     10 modules taking you from zero to running skills
